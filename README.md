...
Below is the explanation of the 5 buttons on the board:
...
| purple| error during parsing (can't find the time slot in the string)   |  
| blue |  error during parsing (wrong number at the time position)   |

...
- {id: LPI2C0_clock.outFreq, value: 24 MHz}
- {id: LPUART1_clock.outFreq, value: 24 MHz}
...
- {id: MRCC.CTIMER1CLKSEL.sel, value: SCG.FRO_HF}
- {id: MRCC.CTIMER2CLKSEL.sel, value: SCG.FRO_HF}
- {id: MRCC.FROHFDIV.scale, value: '1', locked: true}
- {id: MRCC.LPI2C0CLKDIV.scale, value: '4', locked: true}
- {id: MRCC.LPUART1CLKDIV.scale, value: '4', locked: true}
- {id: MRCC.LPUART2CLKDIV.scale, value: '8', locked: true}
- {id: MRCC.OSTIMERCLKSEL.sel, value: VBAT.CLK16K_1}
- {id: SYSCON.AHBCLKDIV.scale, value: '1', locked: true}
sources:
...
void BOARD_BootClockFRO96M(void)
{
    ...
    CLOCK_SetClockDiv(kCLOCK_DivFRO_HF_DIV, 1U);           /* !< Set FROHFDIV divider to value 1 */
    CLOCK_SetClockDiv(kCLOCK_DivLPUART1, 4U);              /* !< Set LPUART1CLKDIV divider to value 4 */
    CLOCK_SetClockDiv(kCLOCK_DivLPUART2, 8U);              /* !< Set LPUART2CLKDIV divider to value 8 */
    CLOCK_SetClockDiv(kCLOCK_DivLPI2C0, 4U);               /* !< Set LPI2C0CLKDIV divider to value 4 */

...
/*
 * Some changes made by myself for the UART-communication
 */
...
void TMC2209_LL::write(uint8_t address, uint8_t reg, uint32_t data)
{
    uint64_t datagram = writeDatagram(address, reg, data);
    send_config_lpuart(datagram);
}

void TMC2209_LL::request(uint8_t address, uint8_t reg)
{
	    uint32_t datagram = requestDatagram(address, reg);
	    send_request_lpuart(datagram);
}

uint64_t TMC2209_LL::respond()
{
    return 1;
}

uint32_t TMC2209_LL::read(uint8_t address, uint8_t reg)
{
    request(address, reg);
    uint64_t datagram = get_response_lpuart();
...
void TMC2209_LL::writeGCONF(TMC2209_UNIT *config, uint32_t value)
{
    ...
    write(config->ADDRESS, TMC2209_REG_ADDRESS::ADDRESS_GCONF, config->GCONF.UINT32);
}
...
void TMC2209_LL::writeIHOLD_IRUN(TMC2209_UNIT *config, uint32_t value)
{
    ...
    write(config->ADDRESS, TMC2209_REG_ADDRESS::ADDRESS_IHOLD_IRUN, config->IHOLD_IRUN.UINT32);
}
...
void TMC2209_LL::writeCHOPCONF(TMC2209_UNIT *config, uint32_t value)
{
    ...
    write(config->ADDRESS, TMC2209_REG_ADDRESS::ADDRESS_CHOPCONF, config->CHOPCONF.UINT32);
}
...
void TMC2209_LL::writePWMCONF(TMC2209_UNIT *config, uint32_t value)
{
    ...
    write(config->ADDRESS, TMC2209_REG_ADDRESS::ADDRESS_PWMCONF, config->PWMCONF.UINT32);
}
...
void TMC2209_LL::writeCOOLCONF(TMC2209_UNIT *config, uint32_t value)
{
    ...
    write(config->ADDRESS, TMC2209_REG_ADDRESS::ADDRESS_COOLCONF, config->COOLCONF.UINT32);
}
...
void TMC2209_LL::writeTCOOLTHRS(TMC2209_UNIT *config, uint32_t value)
{
    ...
    write(config->ADDRESS, TMC2209_REG_ADDRESS::ADDRESS_TCOOLTHRS, config->TCOOLTHRS.UINT32);
}
...
void TMC2209_LL::writeTPWMTHRS(TMC2209_UNIT *config, uint32_t value)
{
    ...
    write(config->ADDRESS, TMC2209_REG_ADDRESS::ADDRESS_TPWMTHRS, config->TPWMTHRS.UINT32);
}
...
void TMC2209_LL::writeSGTHRS(TMC2209_UNIT *config, uint32_t value)
{
    if (value != UINT32_MAX)
        config->SGTHRS = value;
    write(config->ADDRESS, TMC2209_REG_ADDRESS::ADDRESS_SGTHRS, config->SGTHRS);
}
...
void TMC2209_LL::writeTPOWERDOWN(TMC2209_UNIT *config, uint32_t value)
{
    ...
    write(config->ADDRESS, TMC2209_REG_ADDRESS::ADDRESS_TPOWERDOWN, config->TPOWERDOWN);
}

uint32_t TMC2209_LL::readIOIN(TMC2209_UNIT *config)
{
    uint32_t data = read(config->ADDRESS, TMC2209_REG_ADDRESS::ADDRESS_IOIN);
    if (data != UINT32_MAX)
...
{
    uint32_t data = read(config->ADDRESS, TMC2209_REG_ADDRESS::ADDRESS_SG_RESULT);
    if (data != UINT32_MAX)
...
{
    uint32_t data = read(config->ADDRESS, TMC2209_REG_ADDRESS::ADDRESS_IFCNT);
    if (data != UINT32_MAX)
        config->IFCNT = data;
    return data;
}
